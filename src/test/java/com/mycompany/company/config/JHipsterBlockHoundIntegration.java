...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.mycompany.company.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.mycompany.company.security.DomainUserDetailsService", "createSpringSecurityUser");
