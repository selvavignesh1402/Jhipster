...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREATEUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CREATEUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CREATEUSER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_CREATEUSER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_CREATEUSER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CREATEUSER actions', async () => {
      const arg = 42666;
