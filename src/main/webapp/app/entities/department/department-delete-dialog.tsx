...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="companyMongoApp.department.delete.question">
        <Translate contentKey="companyMongoApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
